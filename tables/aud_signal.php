...
<div id="wrapper"> 
  ...
  <div id="page_content">
    ...
    <?php
      ...
      //perform SQL query
      $query = "SELECT * FROM AUDITORY_SIGNAL";
      $result = mysqli_query($link, $query) 
        or die("<br><b>Query failed</b>");

      //print results in html
      echo"<h1>Auditory Signals Table</h1><nl>";

      echo "<blockquote contenteditable=true>";
      echo "<table>\n";
      echo "<td><b>Name</b></td><td><b>Audio URL</b></td><td><b>Description</b></td>";
      ...
      $query = "SELECT * FROM EXHIBITS_AUDITORY_SIGNAL";
      $result = mysqli_query($link, $query) or die("<br><b>Query failed</b></br>");

      echo "<br><h1>Uses Auditory Signal</h1>";
      echo "<blockquote contenteditable=true>";

      echo "<table>\n";
      echo "<td><b>Name</b></td><td><b>Species Name</b></td>";
      while ($line = mysqli_fetch_array($result, MYSQLI_ASSOC)) 
      {
        echo "\t<tr>\n";
        foreach ($line as $col_value) 
