    ...
    <div id="wrapper"> 
      ...
      <div id="page_content">
        ...
        <?php
          ...
          echo "<h1>Family Table</h1><nl>";

          echo "<blockquote contenteditable=true>";
          echo "<table id='familyTable'>\n";
          echo "<td><b>Family Name</b></td><td><b>Additional Information</b></td>";
      ...
      function updateTable()
      {
        ...
        for ( let i = 1, row; row = table.rows[i]; i++ )
        {
          ...
          for ( let j = 0, column; column = row.cells[j]; j++ )
          {
            ...
            let text = column.innerHTML;

            // If the FamilyName exceeds 50 characters
            if ( j == 0 && text.length > 50)
            {
              column.style.color = "#e20404";
            }
            else
            {
            ...
            // If the Description exceeds 1000 characters
            if (j == 1 && text.length > 1000)
            {
              column.style.color = "#e20404";
            }
            else
