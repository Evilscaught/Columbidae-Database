...
<div id="wrapper"> 
  ...
  <div id="page_content">
    ...
    <?php
      ...
      echo"<h1>Pigeon Loft</h1><nl>";

      echo "<blockquote contenteditable=true>";
      echo "<table>\n";
      echo "<td><b>Serial Number</b></td><td><b>Eye Color</b></td><td><b>Weight in Grams</b></td><td><b>Breed</b></td></td><td><b>Date of Birth</b></td>";
      while ($line = mysqli_fetch_array($result, MYSQLI_ASSOC)) 
      {
        echo "\t<tr>\n";
        foreach ($line as $col_value) 
        {
          if (preg_match("/^#[0-9A-F ]*$/i", $col_value))
          {
            echo "\t\t<td style='background-color:$col_value;'>$col_value</td>\n";
          }
          else
          {
